...
def get_mine_data(
  ...
  df = load_dataframe(data_fname=data_path)
...
def get_full_data(
    ...
    patch_size_m=MAG_PATCH_SIZE_M,
    data_path_mag=BINARY_MAGNETIC_GRID_PATH,
    data_path_csv=EXCEL_WORKBOOK_PATH,
):
  df, cols_by_type, target_cols = get_mine_data(
...
def compare_grids(gravity_data_path=BINARY_GRAVITY_GRID_PATH, mag_data_path=BINARY_MAGNETIC_GRID_PATH):
  ...
  grid_mag = GDALGrid(mag_data_path)
  grid_grv = GDALGrid(gravity_data_path)
