# https://raw.githubusercontent.com/metachi/fastaiv2keras/master/fastai/utils.py
    ...
    def on_batch_end(self, batch, logs=None):
        ...
        try:
            ...
            if math.isnan(loss) or loss > self.best*self.jump:
                print('LR_Find loss: %s, self.best*self.jump: %s, self.best: %s, self.jump: %s' % (loss, self.best*self.jump, self.best, self.jump))
                print('LR_Find stopping training')
